    ...
    public class TransferenciaRepository : BaseRepository<Transferencia>
    {
        ...
        public override int Insert(Transferencia entity)
        {
             ...
             using (var transaction = new TransactionScope())
            {
                ...
                unCommand.CommandText = "insert into [QUIEN_BAJO_EL_KERNEL].TRANSFERENCIA (origen, destino, fecha, importe, costo, moneda_tipo, id_transaccion) values (" + entity.origen + ", " + entity.destino + ", \'" + entity.fecha + "\', " + entity.importe + ", " + entity.costo + ", " + entity.monedaTipo + ", " + entity.idTransaccion + ")";
